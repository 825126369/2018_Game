...
namespace ProtoBuf
{
    ...
    public sealed class ProtoWriter : IDisposable
    {
        ...
        public static void WriteFieldHeader(int fieldNumber, WireType wireType, ProtoWriter writer) {
            if (writer == null) throw new ArgumentNullException("writer");
            if (writer.wireType != WireType.None) throw new InvalidOperationException("Cannot write a " + wireType.ToString()+ " header until the " + writer.wireType.ToString() + " data has been written");
            ...
            if (writer.packedFieldNumber == 0) {
                Console.WriteLine("WriteFieldHeader:writer.packedFieldNumber == 0");
                writer.fieldNumber = fieldNumber;
        ...
        internal static void WriteHeaderCore(int fieldNumber, WireType wireType, ProtoWriter writer)
        {
            uint header = (((uint)fieldNumber) << 3)
                | (((uint)wireType) & 7);
            Console.WriteLine("WriteHeadCore:"+fieldNumber+","+wireType+" | "+header);
        ...
        private static void DemandSpace(int required, ProtoWriter writer)
        {
            ...
            {
                Console.WriteLine("DemandSpace if true");
                if (writer.flushLock == 0)
                {
            ...
            Console.WriteLine("DemandSpace if false");
        }
        /// <summary>
        ...
        public static void AppendExtensionData(IExtensible instance, ProtoWriter writer)
        {
            ...
            if (extn != null)
            {
                Console.WriteLine("ProtoWSrite: "+extn);
            ...
            {
                Console.WriteLine("ProtoWSrite: extn is  NULL" );
            }
        }
