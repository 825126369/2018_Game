...
namespace ProtoBuf
{
    internal sealed class NetObjectCache
    {
        ...
        {
            Console.WriteLine("SetKeyedObject key:"+key);
            if (key== Root)
            {
                key--;
                Console.WriteLine("SetKeyedObject key== Root:");
                if (value == null)
                {
            ...
            else
            {
                ...
                if (key < list.Count)
                {
                    Console.WriteLine("key < list.Count");
                ...
                {
                    Console.WriteLine("key != list.add(value)");
        ...
        internal void RegisterTrappedObject(object value)
        {
            if (rootObject == null)
            {
                Console.WriteLine("Register TrappedOBject");
                rootObject = value;
            }
            else
            {
